...
export default function FooterSocial() {
  return (
    <div className="space-y-4">
      ...
      {NEWS_ITEMS.length > 0 && (
        <div>
          <h4 className="mb-2 font-sans text-xs font-medium tracking-wide text-[var(--color-text-2)]">
            PR & NEWS
          </h4>
      ...
      {COMPANY_INFO.instagram && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 font-sans text-xs text-[var(--color-text-3)] transition-colors hover:text-[var(--color-text-2)]"
        >
